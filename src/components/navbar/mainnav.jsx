    ...
    return (
        <div className="h-auto mt-10 mb-10">
            ...
            <div className=" left-4 top-15 navbar hidden sm:flex flex-col gap-3 bg-base-100 backdrop-blur-xl fixed z-20 content-center justify-center w-16 h-3/4 md:3/4 border border-gray-200/50 rounded-3xl shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 ">
                ...
                <div className='hover:rounded-2xl hover:bg-base-100/30 p-2 items-cente border-gray-500 group relative'>
                ...
                <div className='hover:rounded-2xl hover:bg-base-100/30 p-2 items-cente ease-in border-gray-500 group relative'>
                ...
                <div className='hover:rounded-2xl hover:bg-base-100/30 p-2 items-center border-gray-500 group relative'>
                ...
                <div className='bg-amber-500 rounded-2xl p-2 content-center justify-center items-center border-gray-500 group relative'>
                    ...
                    <span className="absolute left-16 top-1/2 -translate-y-1/2 w-max bg-base-100 text-white text-xs px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        Add New
                    </span>
                </div>
            ...
            <div className="flex sm:hidden flex-row bg-base-100/90 backdrop-blur-xl fixed bottom-6 left-1/2 transform -translate-x-1/2 z-20 content-center justify-between items-center w-11/12 max-w-md h-20 border border-gray-200/50 rounded-3xl shadow-2xl hover:shadow-blue-500/20 transition-all duration-300 px-4">
