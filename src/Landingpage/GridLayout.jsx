export default function GridCards() {
  const cards = [
    ...
    },
    {
      ...
      description:
        "student will able to mark their attendance and keep track of percentage of attendance they have in each subject",
      icon: "🏗️",
      url: "KnowAttendanceMarking"
    },
    {
      title: "Class Create Teacher",
      description:
        "For faculty ame easy for Attendance taking and managing a class room, teacher can create class.",
      icon: "✍️",
      url: "classCreateTeacher",
    },
    {
    ...
    <div className="min-h-screen flex items-center justify-center bg-black px-6 py-10">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl">
        {cards.map((card, index) => (
          <div
            key={index}
            className="bg-gray-900 text-white p-6 rounded-xl shadow-lg flex flex-col items-start"
          >
            <div className="text-4xl bg-gray-800 p-3 rounded-lg">
              {card.icon}
            </div>
            ...
            >
              <a href={card.url}>Learn Working</a>
            </button>
