...
function LeftDivComp({ props }) {
    ...
    return (
        <div
            className="middle-upper-1 flex flex-row relative bg-black/50 border-amber-300 border-2 justify-between items-center p-2 overflow-hidden w-full md:w-full rounded-2xl h-auto gap-4 m-2 hover:bg-emerald-400 transition duration-300"
        >
